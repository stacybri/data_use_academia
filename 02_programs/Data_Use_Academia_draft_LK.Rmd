...
countries_list <- colnames(articles_year_df[,12:252])
...
source_models <- list(
  '(1)'=feols(log(data_papers_3yr) ~ log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) + Pop.Cen | country + year  , data=reg_pan_extended),
  '(2)'=feols(log(data_papers_3yr) ~ Ag.Cen + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) | country + year , data=reg_pan_extended),
  '(4)'=feols(log(data_papers_3yr) ~  House.Svy  + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) | country + year , data=reg_pan_extended),
  '(5)'=feols(log(data_papers_3yr) ~  Ag.Svy + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) | country + year , data=reg_pan_extended),
  '(6)'=feols(log(data_papers_3yr) ~  Labr.Svy + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) | country + year , data=reg_pan_extended),
  '(7)'=feols(log(data_papers_3yr) ~ Hlth.Svy  + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) | country + year , data=reg_pan_extended),
  '(8)'=feols(log(data_papers_3yr) ~  Bizz.Svy  + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) | country + year , data=reg_pan_extended),
  '(9)'=feols(log(data_papers_3yr) ~  CRVS  + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) | country + year , data=reg_pan_extended)
  )
...
mod <- fixest::feols(log(SPI.INDEX.PIL2.4.5_3yr)~  log(SP.POP.TOTL) + log(NY.GDP.PCAP.PP.KD) | date,
