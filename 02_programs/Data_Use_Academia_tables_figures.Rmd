...
```{r data_use_outcomes, fig.width=8, fig.height=12}
...
```{r data_use_outcomes_gdp, fig.width=9, fig.height=5}
...
```{r data_use_outcomes_pop, fig.width=9, fig.height=5}
p2
...
```{r data_use_outcomes_spi, fig.width=9, fig.height=5}
p3
```
...
```{r subject_correlations, fig.width=10, fig.height=8}
library(GGally)
